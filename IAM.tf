...
/*
resource "azurerm_role_assignment" "synapse-administrator-synapse-workspace" {
  principal_id        = "a84161e8-486c-46c0-8d3f-3a848248cf65"  # The principal ID of the user, service principal, or security group
  role_definition_name = "Synapse Administrator"  # Use an appropriate role like "Synapse Contributor"
